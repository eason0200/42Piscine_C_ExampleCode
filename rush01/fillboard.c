...
int	lookfor0(int board[4][4], int *r, int *c)   //if clues given contain 0, puzzle is invalid
{
	*r = 0;
	*c = 0;
	while (*r < 4)
...
int	fillboard(int board[4][4], int *input)    //ensure pass 3 validtaion check, if passed , go to init board
{
	int	row;
	int	col;
	int	n;
